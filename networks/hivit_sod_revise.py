...
class HiViTSOD(nn.Module):
    def __init__(self, img_size = (512, 1024)):
        ...
        self.conv_ffc1 =nn.Sequential( 
                        nn.Conv2d(256, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
                        nn.BatchNorm2d(128),
                        nn.ReLU(inplace=True)
        )
        self.conv_ffc2 = nn.Sequential(
            nn.Conv2d(512, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True)
        )
        self.conv_ffc3 = nn.Sequential(
    ...
    def forward(self, samples, samples_hivit, pers, xyz, uv, center_points):
        ...
        #print('equi_feat_list_ffc2:',equi_feat_list_ffc2.size())
        #print('equi_feat_list_ffc3:',equi_feat_list_ffc3.size())
        #print('equi_feat_list1:',equi_feat_list1.size())
        #print('equi_feat_list2:',equi_feat_list2.size())
        #print('equi_feat_list3:',equi_feat_list3.size())
        #exit()
        equi_feat_list11 = self.conv_ffc1(equi_feat_list1)
        equi_feat_list22 = self.conv_ffc2(equi_feat_list2)
        equi_feat_list33 = self.conv_ffc3(equi_feat_list3)
        #exit()
        # ============== ERP、E2P 交互 ==============
        ep_feat0 = self.epfusion0(equi_feat_list11, p2e_feat[2])
        ep_feat1 = self.epfusion1(equi_feat_list22, p2e_feat[3])
        ep_feat2 = self.epfusion2(equi_feat_list33, p2e_feat[4])
